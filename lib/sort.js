...
// @nocommit rename
// @nocommit fix type errors...
/**
 * @type {<T, Key>(items: Array.<T>, getKey: (item: T) => Key, compareKeys: (key1: Key, key2: Key) => number) => Array.<Array.<T>>}
 * @param {Array} items
 * @param {(item: any) => any} getKey
 * @param {(key1: any, key2: any) => number} compareKeys
 * @return {Array.<Array>}
 */
